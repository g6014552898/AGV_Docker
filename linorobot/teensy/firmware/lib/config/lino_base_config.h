...
#define COUNTS_PER_REV 2900       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.145       // wheel's diameter in meters
#define PWM_BITS 12               // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.320  // distance between left and right wheels
#define FR_WHEELS_DISTANCE 0.324   // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
